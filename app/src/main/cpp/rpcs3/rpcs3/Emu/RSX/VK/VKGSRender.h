...
private:
    ...
    std::unique_ptr<vk::buffer_upload> null_buffer_view;
    ...
    std::unique_ptr<vk::buffer_upload> m_persistent_attribute_storage;
    std::unique_ptr<vk::buffer_upload> m_volatile_attribute_storage;
    std::unique_ptr<vk::buffer_upload> m_vertex_layout_storage;
